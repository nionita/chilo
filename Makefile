...
perft.exe: $(PERFT_SRC) $(ENGINE_WIN64_OBJ)
	$(WIN64_CXX) $(WIN64_CXXFLAGS) -O3 -DNDEBUG $(WIN64_LDFLAGS) -o $@ $(PERFT_SRC) $(ENGINE_WIN64_OBJ)
...
chilo.exe: $(CHILO_SRC) $(ENGINE_WIN64_OBJ)
	$(WIN64_CXX) $(WIN64_CXXFLAGS) -O3 -DNDEBUG $(WIN64_LDFLAGS) -o $@ $(CHILO_SRC) $(ENGINE_WIN64_OBJ)
