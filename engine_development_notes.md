...
The current reduction tuning is now more aggressive than the original first pass: futility pruning extends through depth 3 with a larger third margin, and quiet-move LMR now uses three move-number tiers instead of two.
