...
- `g3-sr4` is the development population. `g3-sr3-r2m` is the untouched
  selection population. A candidate found by optimizing SR4 must be evaluated
  exactly, on the full SR3-R2M population, before it is treated as robust or
  selected for SPRT.
