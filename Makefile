...
release: perft perft_tests

debug: perft_debug perft_tests_debug

validate: perft_validate perft_tests_validate
...
clean:
	rm -f perft perft_tests perft_debug perft_tests_debug perft_validate perft_tests_validate
